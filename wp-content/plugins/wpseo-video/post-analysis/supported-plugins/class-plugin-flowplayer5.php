 ...
 *
 * @link https://wordpress.org/plugins/flowplayer5/
 *
	...
	class WPSEO_Video_Plugin_Flowplayer5 extends WPSEO_Video_Supported_Plugin {
		...
		public function get_info_for_post_type( $post_id, $post_type, $post, $shortcode = false ) {
			...
			if ( $url !== '' ) {
				...
				/*
				 * {@internal [JRF] I can't find the duration meta field being added anywhere
				 *            in the plugin, but this came from the code *they* provided...}
				 */
