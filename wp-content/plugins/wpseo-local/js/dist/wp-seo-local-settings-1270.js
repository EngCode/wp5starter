...
/**
 * A class to handle all JS on the Yoast SEO: Local settings page.
 */
class Settings {
	/**
  ...
  */
	constructor() {
		this.internalTabLinks = document.querySelectorAll("[data-action=\"link-to-tab\"]");
  ...
  */
	addEventListeners() {
		this.internalTabLinks.forEach(link => {
			link.addEventListener("click", this.goToTab);
		});
	}

	/**
  * Go to the designated tab.
  *
  * @param link
  */
	goToTab(link) {
		const tabId = link.target.dataset.tabId + "-tab";
