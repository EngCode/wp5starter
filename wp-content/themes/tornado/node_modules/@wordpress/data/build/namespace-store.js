...
function createReduxStore(key, options, registry) {
  var enhancers = [(0, _redux.applyMiddleware)((0, _resolversCacheMiddleware.default)(registry, key), _promiseMiddleware.default)];
  ...
  return (0, _redux.createStore)(reducer, initialState, (0, _lodash.flowRight)(enhancers));
}
/**
...
function mapResolvers(resolvers, selectors, fulfillment, store) {
  ...
  var mappedResolvers = (0, _lodash.mapValues)(resolvers, function (resolver) {
    ...
    return (0, _objectSpread2.default)({}, resolver, {
...
function _fulfillWithRegistry() {
  _fulfillWithRegistry = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            resolver = (0, _lodash.get)(namespace, ['resolvers', selectorName]);
